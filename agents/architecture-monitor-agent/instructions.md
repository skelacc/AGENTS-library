# Architecture-Monitor-Agent (AMA) Instructions
...
- Notify doc-registry-agent when a new agent or skill is created.
- If documentation patterns change, suggest DRA updates AGENTS.md references.
